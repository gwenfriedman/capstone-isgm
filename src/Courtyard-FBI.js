...
function CourtyardFBI() {
  ...
  const [startAudio5, setStartAudio5] = useState(false);

  let audio1 = new Audio(intro)
  let audio2 = new Audio(baker1)
  let audio3 = new Audio(baker2)
  let audio4 = new Audio(baker3)
  let audio5 = new Audio(baker4)
  ...
  audio5.addEventListener("canplaythrough", event => {
    setStartAudio5(true)
    console.log("setStartAudio5")
  });
