        ...
        <div style={{ width: '100%' }}>
            ...
            <div className={"caption-container"} style={{ position: "absolute", bottom: 10, left: 50 }}>
                {Captions(
                    ...
                    ["Chief of Security", "Chief of Security", "Chief of Security", "Chief of Security", "Detective Willard", "Chief of Security", "Detective Willard"],
                    [0, 11000, 10000, 8000, 4000, 4500, 7000, 3000],
                    audio, 47000)}
            </div>
