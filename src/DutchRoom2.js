...
function DutchRoom2() {
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            <img src={leftArrow} alt="left arrow" className='leftArrow' onClick={() => navigate("/dutchroom1")} />
            <img src={rightArrow} alt="right arrow" className='rightArrow' onClick={() => navigate("/dutchroom3")} />
        </div>

    )
}

export default DutchRoom2;